...
def obtain_retrain_autodeeplab_args():
    ...
    parser.add_argument('--backbone', type=str, default='resnet', help='resnet101')
    parser.add_argument('--dataset', type=str, default='sealer', help='pascal or cityscapes')
    ...
    parser.add_argument('--resize', type=int, default=128, help='image crop size')
    parser.add_argument('--workers', type=int, default=0, help='number of data loading workers')
    parser.add_argument('--seed', type=int, default=0, metavar='S', help='random seed (default: 1)')
    parser.add_argument('--resume', type=str, default=None, help='put the path to resuming file if needed')

    parser.add_argument('--filter_multiplier', type=int, default=64)
    ...
    parser.add_argument('--net_path', default=None, type=str, help='network path')
    parser.add_argument('--net_arch', default=None, type=str, help='backbone model')
    parser.add_argument('--cell_arch', default=None, type=str, help='cell architecture')

    parser.add_argument('--criterion', default='Dice', type=str)
    ...
    parser.add_argument('--layer', type=int, default=12, help='set autodeeplab layer')
